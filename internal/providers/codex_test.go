...
func TestCodexSyntheticParseAuthError(t *testing.T) {
	...
	// Pinned, not endorsed: "auth expired" matches none of the permission
	// markers, so an expired login is retried like a transient blip. Same
	// gap the claude auth fixture shows; see
